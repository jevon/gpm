...
GPM is an enhanced package manager that bridges the gap between traditional package managers and AI coding assistants. It provides dynamic, intelligent context about your dependencies to LLMs through deep package research, helping them truly understand the packages you're using across Node.js, Python, and Ruby projects.
...
- **Deep package research**: Analyzes package structure, documentation, and usage patterns
- **Dynamic research engine**: Researches any package on-demand with real-time context
...
- **Agent-specific optimization**: Tailors output format for different AI coding tools
- **Intelligent caching**: Stores research results for improved performance
...
- **Deeper package understanding** through advanced research
- **AI-optimized context** tailored to your specific coding assistant
...
4. Deep package research is performed in real-time and cached for performance
...
- `/api/usage/:packageName` - Get common usage patterns for a package
- `/api/research/:packageName` - Get deep research analysis of a package
...
4. Initial research data is collected for the unified server
5. The package is added to the research database for deep analysis
6. Legacy package-specific MCP servers can still be generated if needed
...
# Get comprehensive research about a package
curl http://localhost:3000/api/research/express

# Get common usage patterns
curl http://localhost:3000/api/usage/lodash
```
...
# curl http://localhost:3000/api/research/pandas
```
